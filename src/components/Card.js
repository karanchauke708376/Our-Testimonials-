    ...
    return (
        ...
        <div className="flex flex-col md:relative">
            ...
            <div className="absolute top-[-7rem] z-[10] mx-auto  ">
                ...
                <img className="aspect-square rounded-full w-[140px] h-[140px] z-[25] transition-all duration-200 hover:shadow-xl " 
            ...
            <div className="text-center mt-7">
                ...
                <p className="text-violet-300 uppercase font-bold ">{review.job}</p>
